...
import { addUser, AtomData, changeStatus, deleteUser, EditUser } from '../atom/atom'
...
const Jotai = () => {
  ...
  return (
    <>
    <div>
      <Button type='primary' onClick={showModal} className='ml-[800px] mt-[40px]'>+ New Add</Button>
    </div>
    <div className='flex gap-[30px] m-auto justify-center mt-[50px]'>
     {data.map((user) => {
       return <div className='shadow-lg w-[250px] h-[180px] rounded-3xl flex flex-col items-center justify-center '>
